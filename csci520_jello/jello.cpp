...
void display()
{
  ...
  */
  ...
  GLfloat mKa[] = { 1.0, 1.0, 1.0, 0.7 };
  GLfloat mKd[] = { 0.5, 0.1, 0.1, 0.7 };
  GLfloat mKs[] = { 0.7, 0.5, 0.5, 0.7 };
  GLfloat mKe[] = { 0.0, 0.0, 0.0, 0.1 };
...
void doIdle()
{
  char s[25]="./animation/picxxxx.ppm";
  int i;
  ...
  if (pause == 0)
  {
    // insert code which appropriately performs multiple steps of the cube simulation based on jello.n:
